...
- **tr-ai-cing** — LLM monitoring and observability platform.  
  GitHub: [github.com/jwgwalton/tr-ai-cing](https://github.com/jwgwalton/tr-ai-cing)  
  Stack: Python, LLM observability

- **traceTTY** — LLM application tracing with terminal-first visualization workflows.  
  GitHub: [github.com/jwgwalton/traceTTY](https://github.com/jwgwalton/traceTTY)  
  Stack: Python, tracing, developer tooling

- **deep-eval-testing** — Experimentation with evaluation frameworks for LLM applications and prompts.  
  GitHub: [github.com/jwgwalton/deep-eval-testing](https://github.com/jwgwalton/deep-eval-testing)  
  Stack: Python, DeepEval, LLM testing

- **DataAtelier** — Human-in-the-loop data cleansing tool leveraging LLMs for scalable workflows.  
  GitHub: [github.com/jwgwalton/DataAtelier](https://github.com/jwgwalton/DataAtelier)  
  Stack: Python, LLM workflows
