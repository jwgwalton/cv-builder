...
- Rewrote a data processing framework in Polars from Apache Spark, curating a representative dataset to validate the rewrite with classical ML metrics and optimise both model performance and processing speed. This reduced cloud costs by ~£10k per month, reducing run time from 2 hours to 10 minutes.
