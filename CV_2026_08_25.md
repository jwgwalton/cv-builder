...
Senior AI and machine learning engineer with over 10 years of experience delivering production systems across regulated government, financial services, intellectual property and defence environments. Hands-on expertise in Python, Generative AI, RAG, agentic systems, LangChain, LangGraph and Azure AI services. Proven technical leader across architecture, implementation, evaluation, observability and multi-environment deployment, with delivered solutions saving approximately £2M annually. Strong advocate for secure, responsible AI who communicates effectively with engineering, architecture, business and international stakeholders.
...
- **Programming & Integration:** Python, SQL, Java, Azure Functions, service-oriented systems
- **Search & Data:** Elasticsearch, vector search, HNSW, Apache Spark, Polars, Pandas, NumPy
- **MLOps & CI/CD:** Azure ML Pipelines, Vertex AI Pipelines, MLflow, Git, Docker, multi-environment deployment
- **Cloud Platforms:** Microsoft Azure, Google Cloud Platform, AWS
- **Machine Learning:** Hugging Face, BERT, TensorFlow, PyTorch, Scikit-learn
...
- Designed and delivered a production agentic data-processing solution with Python, Azure AI Foundry, Azure Functions and LangGraph, saving case workers two hours per day and approximately £2M annually.
...
- Developed production Generative AI applications within a service-oriented architecture using Python, LangChain, Azure OpenAI and Azure Functions.
- Built a RAG agent over unstructured text to help users identify relevant Goods and Services terms.
...
- Set the product roadmap for AI applications, balancing opportunities, risks and delivery constraints.
